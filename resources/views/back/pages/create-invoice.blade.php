...
@section('content')
    ...
    <form action="{{ route('admin.store-invoice') }}" method="POST" id="invoiceForm">
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="po_number" id="po_number" placeholder="Enter Purchase Order Number">
                                    @error('po_number')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                                        ...
                                                        <table class="table table-bordered mb-0">
                                                            <tbody>
                                                                ...
                                                                <tr class="table-active">
                                                                    ...
                                                                    <td class="text-end"><strong><span id="grand_total_display">0.00</span></strong></td>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('invoiceForm').addEventListener('submit', function(e) {
            ...
            submitButton.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i>Creating Invoice...';
