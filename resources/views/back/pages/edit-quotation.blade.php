...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Edit Quotation')
...
@section('content')
    ...
    <form action="{{ route('admin.update-quotation', $quotation->id) }}" method="POST" id="editQuotationForm">
        @csrf
        @method('POST')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="attention" id="attention" 
                                           value="{{ $quotation->attention }}" placeholder="Enter attention/person name">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="quotation_for" id="quotation_for" 
                                           value="{{ $quotation->quotation_for }}" placeholder="Enter quotation purpose">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="notes" id="notes" rows="3" 
                                            placeholder="Enter any additional notes or remarks...">{{ old('notes', $quotation->notes ?? '') }}</textarea>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="is_tax_included" name="is_tax_included" value="1"
                                                        {{ $quotation->is_tax_included ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="is_delivery_charges_included" name="is_delivery_charges_included" value="1"
                                                        {{ $quotation->is_delivery_charges_included ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="is_printing_included" name="is_printing_included" value="1"
                                                        {{ $quotation->is_printing_included ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="is_plate_and_punch" name="is_plate_and_punch" value="1"
                                                        {{ $quotation->is_plate_and_punch ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-3 mt-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="is_lamination" name="is_lamination" value="1"
                                                        {{ $quotation->is_lamination ? 'checked' : '' }}>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="gsm[]" class="form-control form-control-sm" 
                                                                   value="{{ $item->gsm }}" placeholder="GSM">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="base_price[]" class="form-control form-control-sm base-price" 
                                                                   min="0" step="0.01" value="{{ $item->base_price }}" placeholder="0.00" required>
                                                        </td>
